...
export const AddTaskComponent=()=>{
        ...
        return (<div>
                ...
                <form onSubmit={SubmitHandler} className='search-component'>
                        <input type="text" onChange={FormHandler} name="username" value={task} placeholder='Add Task...' maxLength={25} required/>
                        <button type="submit"  className='add'>
                        <TiTick className="icon-container" size={30}/>
                        </button>
                </form>
                <TaskComponent activities={items} complete={CompletedHandler} delete={DeleteHandler} pending={pending} />
